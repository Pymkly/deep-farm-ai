      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center">
        ...
        <Reveal delay={0.1}>
          <h2 className="mt-6 text-balance text-3xl font-bold leading-[1.05] sm:text-6xl">
            Deep Farm at the 1st Indian Ocean AI Summit
          </h2>
        </Reveal>
        <Reveal delay={0.2}>
          <p className="mx-auto mt-6 max-w-2xl text-balance text-lg text-white/75">
            Join us on May 28–29, 2026 in Antananarivo, under the patronage
            of the Prime Minister of Madagascar.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-white/70">
            <span className="inline-flex items-center gap-2">
              <Calendar className="h-4 w-4 text-earth" /> May 28–29, 2026
            </span>
            <span className="inline-flex items-center gap-2">
              <MapPin className="h-4 w-4 text-earth" /> Antananarivo, Madagascar
            </span>
          </div>
        </Reveal>
        <Reveal delay={0.4}>
