...
const agents = ["Document Agent", "Image Agent", "Time Series Agent", "Weather Agent"];
      ...
      <div className="relative mx-auto max-w-7xl px-4">
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-xs uppercase tracking-[0.2em] text-sky">See it in action</p>
            <h2 className="mt-3 text-balance text-3xl font-bold leading-tight sm:text-5xl">
              From a leaf photo to a sourced diagnosis in under a minute.
            </h2>
          </div>
        </Reveal>
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          {/* Step 1 */}
          <Reveal delay={0}>
            <Step number="01" title="Capture" icon={Camera}>
              <div className="mx-auto mt-4 w-44 rounded-[2rem] border-[10px] border-white/15 bg-gradient-to-b from-emerald-900 to-emerald-950 p-3 shadow-xl">
                <div className="aspect-[9/16] rounded-2xl bg-gradient-to-br from-emerald-700 via-emerald-800 to-emerald-950 p-3">
                  ...
                  <p className="mt-3 text-center text-[10px] text-white/70">Tap to scan a leaf</p>
          ...
          {/* Step 2 */}
          <Reveal delay={0.12}>
            <Step number="02" title="Reason" icon={Sparkles}>
          ...
          {/* Step 3 */}
          <Reveal delay={0.24}>
            <Step number="03" title="Recommend" icon={FileText}>
              <div className="mt-4 rounded-xl border border-white/10 bg-white/5 p-4">
                <div className="flex items-center gap-2 text-xs text-emerald-300">
                  <span className="h-2 w-2 rounded-full bg-emerald-400" />
                  Diagnosis · 94% confidence
                </div>
                <p className="mt-2 text-base font-semibold">Bacterial Blight</p>
                <p className="mt-2 text-xs leading-relaxed text-white/70">
                  Apply copper-based bactericide. Drain plot for 48h, then re-flood.
