...
export function EventCard() {
  ...
  return (
    <a
      ...
      className="group pointer-events-auto ml-auto flex max-w-[300px] items-start gap-3 rounded-2xl border border-earth/30 bg-earth/15 p-4 text-white shadow-xl shadow-earth/20 backdrop-blur-md transition-all hover:-translate-y-0.5 hover:border-earth/50 hover:bg-earth/25 hover:shadow-earth/30"
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-earth">
